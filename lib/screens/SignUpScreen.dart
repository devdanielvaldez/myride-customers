...
import 'package:myridedriverapp/Services/AuthService.dart';
...
class SignUpScreenState extends State<SignUpScreen> {
  ...
  TextEditingController fichaDriverController = TextEditingController();
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (isAcceptedTc) {
        ...
        Map req = {
          ...
          "ficha_driver": fichaDriverController.text.trim(),
        };
                  ...
                  content: Form(
                    ...
                    Column(
                      children: [
                        ...
                        AppTextField(
                          textFieldType: TextFieldType.NAME,
                          controller: fichaDriverController,
                          decoration: inputDecoration(context, label: "Ficha"),
                          validator: (value) {
